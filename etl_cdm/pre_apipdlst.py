    ...
    try :
        ...
        oracle_sql = """
                        ...
                        from 
                            %s
                        where
                            substr(ADMTIME, 1, 8) between '%s' and '%s' 
        ...
        while True :
            ...
            dw_df = pd.DataFrame(oracle_result, columns = ["PATNO", "ADMTIME", "PATFG", "OPSEQNO", "MEDDEPT", "ADMORDDR", "CHADR", "GENDR", "SPCDR", "FSTMEDTYP", "NIGHTTYP", "HOLIDAYN", "ERDEPT", "OIFG", "WARDNO", "ROOMNO", "BEDNO", "WARDNOCARE", "ROOMNOCARE", "BEDNOCARE", "WARDNO2", "ROOMNO2", "BEDNO2", "LOCATE", "KIDCANCER", "FROMDIET", "DIETCODE", "DIAGCODE", "ADMPATH", "ERTIME", "MOMPATNO", "SICKBABYYN", "MATENAME", "MATEBIRTH", "DSCHORDTIME", "DSCHPLDATE", "DSCHTIME", "DSCHTYP", "DSCHRSLT", "DRGYN", "DRGCODE", "MEDDAY", "REJTTIME", "REJTCD", "MOMADMTIME", "PJTCODE", "HVCAFG", "MEDCENTER", "REGTIME", "EDITTIME", "KTASLVLCD", "NOTICODE", "RFIDCONFG", "PREGYN", "PROTECTOR", "RELATION", "PSYCOADMFG", "ETLDATE"] )
            dw_df.fillna('None')
            ...
            sql = """
                insert into cdmpv531.pre_apipdlst
                (patno, admtime, patfg, opseqno, meddept, admorddr, chadr, gendr, spcdr, fstmedtyp, nighttyp, holidayn, erdept, oifg, wardno, roomno, bedno, wardnocare, roomnocare, bednocare, wardno2, roomno2, bedno2, locate, kidcancer, fromdiet, dietcode, diagcode, admpath, ertime, mompatno, sickbabyyn, matename, matebirth, dschordtime, dschpldate, dschtime, dschtyp, dschrslt, drgyn, drgcode, medday, rejttime, rejtcd, momadmtime, pjtcode, hvcafg, medcenter, regtime, edittime, ktaslvlcd, noticode, rfidconfg, pregyn, protector, relation, psycoadmfg, etldate)
                values %s;
                """
